...
namespace MVC.RdlcReport.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,DesignationId,JoiningDate")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,DesignationId,JoiningDate")] Employee employee)
        {
            if (ModelState.IsValid)
            {
